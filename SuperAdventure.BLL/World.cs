...
namespace SuperAdventure.BLL
{
    public static class World
    {
        ...
        public static Item ItemById(int id) => _items.SingleOrDefault(x => x.Id == id);
        public static Monster MonsterById(int id) => _monsters.SingleOrDefault(x => x.Id == id);
        public static Quest QuestById(int id) => _quests.SingleOrDefault(x => x.Id == id);
        public static Location LocationById(int id) => _locations.SingleOrDefault(x => x.Id == id);
    }
}
